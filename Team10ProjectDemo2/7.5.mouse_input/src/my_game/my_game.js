...
class MyGame extends engine.Scene {
    constructor() {
        ...
        this.kBgSpace = "assets/bg_space.png";
    ...
    load() {
        ...
        engine.texture.load(this.kBgSpace);
    }
    ...
    unload() {
        ...
        engine.texture.unload(this.kBgSpace);
    }
    ...
    init() {
        ...
        this.mInventory = new engine.Inventory(this.kBgSpace);
        this.mInventory.setInventoryPosition(65, 55);
        this.mInventory.setInventorySize(60, 10);
    ...
    update() {
        ...
        if (engine.input.isButtonClicked(engine.input.eMouseButton.eLeft)) {
            this.mInventory.addItem(this.mPortal);
        }

        if (engine.input.isButtonClicked(engine.input.eMouseButton.eMiddle)) {
            this.mInventory.addItem(this.mLMinion);
        }
